erpnext.utils.update_child_items = function (opts) {
    ...
    if (frm.doc.doctype == "Sales Order" || frm.doc.doctype == "Purchase Order") {
        fields.splice(2, 0, { fieldtype: "Date", fieldname: frm.doc.doctype == "Sales Order" ? "delivery_date" : "schedule_date", in_list_view: 1, label: frm.doc.doctype == "Sales Order" ? __("Delivery Date") : __("Reqd by date"), reqd: 1 });
        fields.splice(3, 0, { fieldtype: "Float", fieldname: "conversion_factor", label: __("Conversion Factor"), precision: get_precision("conversion_factor") });
    }

    if (frm.doc.doctype == "Purchase Order" && frm.doc.is_subcontracted && !frm.doc.is_old_subcontracting_flow) {
        fields.push(
            { fieldtype: "Link", fieldname: "fg_item", options: "Item", reqd: 1, in_list_view: 0, read_only: 0, disabled: 0, label: __("Finished Good Item"), get_query: () => { return { filters: { is_stock_item: 1, is_sub_contracted_item: 1, default_bom: ["!=", ""] } }; } },
            { fieldtype: "Float", fieldname: "fg_item_qty", reqd: 1, default: 0, read_only: 0, in_list_view: 0, label: __("Finished Good Item Qty"), precision: get_precision("fg_item_qty") }
        );
    }
    ...
    let dialog = new frappe.ui.Dialog({
        ...
        size: "extra-large",
        fields: [
            { fieldname: "trans_items", fieldtype: "Table", label: "Items", cannot_add_rows: cannot_add_row, in_place_edit: false, reqd: 1, data: this.data, get_data: () => { return this.data; }, fields: fields }
        ],
        ...
        update_items: function () {
            ...
            const check_project_and_proceed = () => {
                if (frm.doc.doctype === "Sales Order" && !frm.doc.project) {
            ...
            if (frm.doc.doctype === "Sales Order" && frm.doc.docstatus === 1) {
                frappe.call({
                    ...
                    callback: function(r) {
                        if (r.message) {
                            ...
                            // Gray out background behind Discrepancy confirmation
                ...
                // Not a submitted Sales Order -> Skip Phase 1, proceed to Phase 2
                check_project_and_proceed();
            }
        },
