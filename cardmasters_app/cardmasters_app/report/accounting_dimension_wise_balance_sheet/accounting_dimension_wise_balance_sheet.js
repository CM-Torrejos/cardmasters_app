...
frappe.query_reports["Accounting Dimension-wise Balance Sheet"] = $.extend(
	{},
	erpnext.financial_statements
);

frappe.query_reports["Accounting Dimension-wise Balance Sheet"].filters =
...
frappe.query_reports["Accounting Dimension-wise Balance Sheet"].filters.push(
	{
	...
	},
	{
		...
		get_data: function (txt) {
			const report = frappe.query_reports["Accounting Dimension-wise Balance Sheet"];
...
frappe.query_reports["Accounting Dimension-wise Balance Sheet"].onload = function (report) {
