...
def update_child_qty_rate(parent_doctype, trans_items, parent_doctype_name, child_docname="items"):
	...
	for d in data:
		...
		# get subclass
		if d.get("custom_subclass"):
			child_item.custom_subclass = d.get("custom_subclass")

		# get item specifics
		if d.get("custom_item_specifics"):
			child_item.custom_item_specifics = d.get("custom_item_specifics")

		# get particulars
		if d.get("custom_particulars"):
			child_item.custom_particulars = d.get("custom_particulars")
